...
import { initZpl } from "zpl-renderer-js/external";
...
test("Renders ZPL using external wasm and initZpl", async () => {
  const { api } = await initZpl({
    wasmUrl: "https://raw.githubusercontent.com/fabiolb/zplJS/main/dist/zpl.wasm",
  });
