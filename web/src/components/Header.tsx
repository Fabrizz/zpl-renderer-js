...
export default function Header() {
  return (
    <header className="flex h-12 items-center justify-between gap-2 overflow-hidden relative border-b border-white/10 bg-neutral-900/80 text-white">
      <span className='absolute h-9 w-16 -top-4 -left-2 bg-[#fdbd5d] z-0 blur-[30px]'></span>
      <div className='flex items-center gap-3 z-10 px-3'>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              variant={'outline'}
              className='rounded-md px-1.5! h-6 flex items-center gap-1.5 text-white/70 font-normal'>
              <Info className='inline size-3.5' />
              <span className='text-xs pr-0.5'>What is this?</span>
            </Button>
          </DialogTrigger>
          <DialogContent className='rounded-2xl min-w-xl'>
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 mb-3 font-heading">
              ...
              <DialogDescription className="mb-1 flex flex-col w-full gap-2">
                ...
                <div>
                  <a href='https://github.com/Fabrizz/zpl-renderer-js/' className='flex flex-col gap-2 bg-[#1e1e1e] px-3 py-3 rounded-t-md'>
                    <div className='flex items-center gap-2'>
                      <h1 className="text-xl text-white flex gap-2 items-center w-full">
                        <span className="font-heading font-extrabold">Zpl-Renderer-JS</span>
                        <span className='flex items-center gap-1 bg-red-500/20 text-xs px-2 rounded-md text-red-300'>
                          ...
                          <span className='text-sm font-heading font-semibold'>npm</span>
                        </span>
                ...
                <a href='https://github.com/Fabrizz/' className='flex flex-col gap-2 bg-[#1e1e1e] px-3 py-3 rounded-md'>
                  <h1 className="text-xl font-extrabold text-white flex gap-2.5 items-center w-full">
                    ...
                    <span className='font-heading! text-lg font-extrabold text-white flex gap-0 items-center -mt-1'>
                ...
                <p className='text-sm flex flex-col gap-1 px-2'>
                  ...
                  <span className='mt-0.5'>Made with {"<3"} by Fabrizio.</span>
                </p>
      ...
      <div className='flex flex-row'>
        ...
        <div className='flex items-center gap-2 z-10 border-l border-border hover:bg-white/10 transition-all'>
          <a href='https://github.com/Fabrizz/zpl-renderer-js'
            ...
            <span className='flex flex-col gap-px'>
              <span className='text-xs hidden lg:flex flex-row items-center gap-1'>
                <svg
                ...
                <span className='font-bold font-heading!'>zpl-renderer-js</span>
              </span>
              <span className='hidden lg:inline text-xs font-sans!'>In-browser ZPL to PNG library</span>
            </span>
          </a>
        </div>
      </div>
